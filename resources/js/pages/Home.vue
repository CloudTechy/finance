                            ...
                            <div class=" col p-4 partners-container">
                                ...
                                <div class="services mt-3">
                                    <ul class="row">
                                        <li class="col text-center">
                                            <div class="inner-s"><img src="http://localhost:8000/img/key-1.png" class="centered-img">
                                        ...
                                        <li class="col text-center">
                                            <div class="inner-s"><img src="http://localhost:8000/img/key-2.png" class="centered-img">
                                        ...
                                        <li class="col text-center">
                                            <div class="inner-s"><img src="http://localhost:8000/img/key-4.png" class="centered-img">
                                ...
                                <div class=" m-0 p-0 mt-4 pt-4  partners-container">
                                    ...
                                    <p>Bfin Financial Services offers daily, weekly and monthly varieties of profit plans for our valuable investors. The investment plans have been prepared with great care and structured into amazing portfolios.<br><br>
                                        ...
                                        Upto 60%
                                        14 days turnover
                                        10% Referral Commission to the 10th chain.<a href="/investmentPlans" class="btn btn-link" style="display: inline; line-height: 20px; font-size: 13px; color: rgb(183, 183, 183); font-family: Montserrat; text-transform: uppercase;">Read More</a></p>
                                </div>
                                <div class="m-0 p-0 text-center justify-content-center row mb-3 inv-plans">
                                    <div class="col m-md-3 m-1 alpha omega">
                                        <div class="col plan-wrap first">
                                            ...
                                            <div class="inv-button"><a href="/user/dashboard/deposit" class="btn btn-inverse">Make Investment</a></div>
                                        </div>
                                    </div>
                                ...
                                <div class="m-1 mt-4 pt-5 m-0 p-0 partners-container">
                                    ...
                                    <div class="partners-img clearfix"><img src="http://localhost:8000/img/percentages.png"> <img src="http://localhost:8000/img/partners.png"></div>
                                </div>
                                ...
                                <div class="data-map"><img src="http://localhost:8000/img/map.png" class="img-responsive">
                                ...
                                <div class="data-center-services">
                                    ...
                                    <div class="row">
                                        <div class="column col dcs"><img src="http://localhost:8000/img/dcs-1.png" class="centered-img">
                                        ...
                                        <div class="column col dcs"><img src="http://localhost:8000/img/dcs-2.png" class="centered-img">
                                        ...
                                        <div class="column col dcs"><img src="http://localhost:8000/img/dcs-3.png" class="centered-img">
