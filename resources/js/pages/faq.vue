    ...
    <div>
        <div class="row page-title m-3 p-2">
            <div class="col-12 col-lg-8 container">
                ...
                <p>Please go through the Frequently asked questions. Following are the answers to most common questions that may arise in any investor’s mind to know Biofeed Investment Limited better. </p>
            </div>
        </div>
                                    ...
                                    <div class="row">
                                        <div class="column">
                                            <div class="faq-section">
                                                ...
                                                <ul class="faq">
                                                    <li class="panel">
                                                        <a class="que" data-toggle="collapse" data-parent="#accordion" aria-expanded="false" href="#collapse1">What is Biofeed Investment Limited? </a>
                                                        <div class="ans panel-body collapse in" id="collapse1">
                                                            <p>Biofeed Investment is an expert trading company.</p>
                                                        </div>
                                                    </li>
                                                    <li class="panel">
                                                        <a class="que collapsed" href="#collapse2" data-toggle="collapse" data-parent="#accordion">Is Biofeed Investment Limited available to public? </a>
                                                        <div class="ans panel-body collapse" id="collapse2">
                                                            <p>Biofeed Investment Limited is open for public who are 18 and fulfill the legal age to take part in our program. </p>
                                                        </div>
                                                    </li>
                                                    <li class="panel">
                                                        <a class="que collapsed" href="#collapse3" data-toggle="collapse" data-parent="#accordion">How can I check the authenticity of Biofeed Investment Limited? </a>
                                                        <div class="ans panel-body collapse" id="collapse3">
                                                            <p>Biofeed Investment is fully regulated by the Financial Industry Regulatory Authority. You can visit to vetrify https://brokercheck.finra.org/firm/summary/282643/</p>
                                                        </div>
                                                    </li>
                                                    <li class="panel">
                                                        <a class="que collapsed" href="#collapse4" data-toggle="collapse" data-parent="#accordion">How Does Biofeed Investment Limited make profit? </a>
                                                        <div class="ans panel-body collapse" id="collapse4">
                                                            <p>Biofeed Investment For the past two years, our unique alogrithm remains relevant, this the major secret why we win. </p>
                                                        </div>
                                                    </li>
                                                    <li class="panel">
                                                        ...
                                                        <div class="ans panel-body collapse" id="collapse5">
                                                            <p>Biofeed Investment Limited is a platform which is risk-free. However, to avoid unforeseen loss, the company continuously fills in its contingency fund. In the case of force majeure situations, Biofeed Investment Limited's investors can expect to receive money back except the profits they received earlier.</p>
                                                        </div>
                                                    </li>
                                                </ul>
                                            </div>
                                            <div class="faq-section">
                                                ...
                                                <ul class="faq">
                                                    <li class="panel">
                                                        <a class="que collapsed" href="#collapse6" data-toggle="collapse" data-parent="#accordion">How can I start investing with Biofeed Investment Limited ? </a>
                                                    ...
                                                    <li class="panel">
                                                        ...
                                                        <div class="ans panel-body collapse" id="collapse7">
                                                            <p>Please check the information you have entered. You may contact our support team at <a href="mailto:info@biofeedincinvestment.com">info@biofeedincinvestment.com </a> if you need our assistance. We will be glad to help you. </p>
                                                        </div>
                                                    </li>
                                                    <li class="panel">
                                                        <a class="que collapsed" href="#collapse8" data-toggle="collapse" data-parent="#accordion">I wish to invest with Biofeed Investment Limited but I don't have any e-currency account. What should I do? </a>
                                                    ...
                                                    <li class="panel">
                                                        <a class="que collapsed" href="#collapse9" data-toggle="collapse" data-parent="#accordion">Can I have more than one account at Biofeed Investment ? </a>
                                                        <div class="ans panel-body collapse" id="collapse9">
                                                            <p>No, each member can have only one account in Biofeed Investment Ltd. Any attempt of fraud will result in permanent blocking of the account &amp; the funds deposited in the account will be frozen. </p>
                                                        </div>
                                                    </li>
                                                    <li class="panel">
                                                        ...
                                                        <div class="ans panel-body collapse" id="collapse10">
                                                            <p>Please contact us at info@biofeedincinvestment.com and we will update your account within 24 hours. </p>
                                                        </div>
                                                    </li>
                                                    <li class="panel">
                                                ...
                                                <ul class="faq">
                                                    <li class="panel">
                                                        ...
                                                        <div class="ans panel-body collapse" id="collapse18">
                                                            <p>Just login to your Biofeed Investment Limited account and proceed with your withdrawal at the Withdraw section. </p>
                                                        </div>
                                                    </li>
                                                    <li class="panel">
                                            ...
                                            <div class="faq-section">
                                                ...
                                                <ul class="faq">
                                                    <li class="panel">
                                                        <a class="que collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapse22">Do you have a referral program in Biofeed Investment Limited? </a>
                                                        <div class="ans panel-body collapse" id="collapse22">
                                                            <p>Yes we have a 5 level referral program in Biofeed Investment Limited. </p>
                                                        </div>
                                                    </li>
                                                    <li class="panel">
                                                        <a class="que collapsed" href="#collapse23" data-toggle="collapse" data-parent="#accordion">What are the referral commissions in Biofeed Investment Limited? </a>
                                                        <div class="ans panel-body collapse" id="collapse23">
                                                            <p>For direct referrals you will get upto 10% interest on the amount deposited by the referee. It all depends on your plan. SEE: https://www.biofeedincinvestment.com/partners.</p>
                                                        </div>
                                                    </li>
                                                    <li class="panel">
                                                        <a class="que collapsed" href="#collapse24" data-toggle="collapse" data-parent="#accordion">Do I need to have active investment in order to participate in Biofeed Investment Limited's referral program ? </a>
